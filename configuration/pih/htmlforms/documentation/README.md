...
The possible answers column should contain the answer names (not mappings), and the concept columns should use the format "PIH:14706".  If commas are needed within a value, ensure the value is correctly quoted as valid CSV.
